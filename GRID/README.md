...
6. To quantify the model run 'scripts/GRIDData.m'. This will invert all fundamentals and calibrate the model. No adjustments are necessary; all inputs will be found automatically.
