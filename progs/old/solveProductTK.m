...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% This function is a modified version of the on included in the       %%%
%%% original replication directory
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


function product = solveProductTK(L_n, R_n, w_n, v_n, dni)
...
% Make global scalars accessible
    ...
    while count < maxiter
        ...
        % Begin by computing the numerator in SW2020 Eq. (10)
            ...
            num = repmat(num', nobs, 1);                                    % Transpose the matrix so that spending destinations are in columns and replicate by J rows to obtain a JxJ matrix
